...
import nayacode.studio.awascovid_19.CasesCountryActivity;
...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public MyCustomAdapter(Context context, List<CountryModel> countryModelsList) {
        super(context, R.layout.list_item_country, countryModelsList);
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                CasesCountryActivity.countryModelsList = (List<CountryModel>) results.values;
